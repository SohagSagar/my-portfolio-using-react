...
const ServiceCard = ({service}) => {
    ...
    return (
        <div class=" card w-96  h-56 bg-base-300 service-card hover:bg-primary  transition  duration-700  hover:duration-700 hover:transition-all">
            <div class="card-body hover:ring">
