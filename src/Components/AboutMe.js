...
const AboutMe = () => {
    return (
        <div id='about' className='py-5 lg:pb-10'>
            ...
            <div className='mt-[-220px]'>
                <div className="hero min-h-screen bg-secondary">
                    ...
                    <div className="hero-content flex-col lg:flex-row-reverse">
                        <img src={aboutBg} alt="" className="lg:max-w-lg rounded-lg shadow-2xl pt-10 lg:pt-0" />
                        <div className='text-white'>
                            
                            <h1 className="text-xl lg:text-3xl mt-3 lg:mt-0 font-bold">I'm a tech Enthogious person and loved <br /> to play with new technologies...</h1>
                            <p className="py-6 text-sm lg:text-lg text-justify">After done my graduation in Computer Science and Engineering I focus in web development as my career and loved to work  in frontend development because of experiencing different kind of user interface. Currently I exploring React and it's relavent libraries. </p>
