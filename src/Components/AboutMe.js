            ...
            <div className='mt-[-220px]'>
                <div class="hero min-h-screen bg-secondary">
                    ...
                    <div class="hero-content flex-col lg:flex-row-reverse">
                        <img src={aboutBg} class="lg:max-w-lg rounded-lg shadow-2xl" />
                        <div className='text-white'>
                            
                            <h1 class="text-3xl font-bold">I'm a tech Enthogious person and loved <br /> to play with new technologies...</h1>
                            <p class="py-6 text-lg text-justify">After done my graduation in Computer Science and Engineering I focus in web development as my career and loved to work  in frontend development because of experiencing different kind of user interface. Currently I exploring React and it's relavent libraries. </p>
                            ...
                            <div className='py-6'>
                                <button class="btn btn-primary rounded-full btn-outline w-36">Hire me</button>
                            </div>
                        </div>
                    </div>
                </div>
